// icon:basketball-outline | Ionicons https://ionicons.com/ | Ionic Framework
import * as React from "react";

function IconBasketballOutline(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 512 512"
      fill="currentColor"
...
export default IconBasketballOutline;
